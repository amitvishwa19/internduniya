        ...
        <form  method="post" action="{{route('company.internship.update',$internship->id)}}" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="pf-field">
                        <input type="number" id="pincode" name="post_code" value="{{old('post_code')}}{{$internship->pincode}}" autocomplete="off" >
                ...
                <div class="col-lg-6">
                    ...
                    <div class="pf-field">
                        ...
                        <input type="text" id="city" name="city" value="{{old('city')}}{{$internship->city}}" autocomplete="off" >
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="pf-field">
                        ...
                        <input type="text" id="state" name="state" value="{{old('state')}}{{$internship->state}}" autocomplete="off" >
